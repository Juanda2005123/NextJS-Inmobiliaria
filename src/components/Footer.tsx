    ...
    <footer className="bg-gray-900 border-t border-gray-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Columna 1: Branding */}
          <div>
            <Link href="/dashboard" className="flex items-center gap-2 mb-4 hover:opacity-80 transition-opacity w-fit">
              <Building2 className="w-6 h-6 text-blue-500" />
              <span className="text-lg font-light tracking-tight text-gray-100">
                Inmobiliaria<span className="font-semibold text-blue-500">.pro</span>
              </span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed">
              Plataforma moderna de gestión inmobiliaria. 
              Simplificamos tu trabajo diario.
            </p>
          </div>
